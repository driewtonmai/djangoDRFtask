# Generated by Django 2.2.6 on 2019-11-17 13:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('impath', models.CharField(max_length=20, verbose_name='Impath')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.IntegerField(blank=True, choices=[(1, 'phone'), (2, 'email'), (3, 'facebook')], null=True, verbose_name='Variants')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addres', models.CharField(max_length=128, verbose_name='Adress')),
